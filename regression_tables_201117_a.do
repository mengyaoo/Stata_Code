...
estadd local statedayFE "Yes"
estadd local cluster "State"
esttab using 201117_a/table_robust_ftwork.rtf, replace label title(Robustness: Full-Time Work Ratio) noobs s(N r2_a zipFE citydayFE countydayFE statedayFE cluster, label("N" "Adj. R-squared" "Zip-code FE" "City-Day FE"  "County-Day FE"  "State-Day FE"  "Clusters" ) fmt(0 %9.3f)) star(* .10 ** .05 *** .01) nocon b(3) drop(_cons 0.prepolicy_30day* demo_asian population_log  establishment_log teleworkable_emp_establish social_capital_county 1.prepolicy_30day exposure_total_scaled) order(1.prepolicy_30day#c.exposure_total_scaled 1.prepolicy_30day 1.prepolicy_30day#c.social_capital_county  1.prepolicy_30day#c.cases cases 1.prepolicy_30day#c.deaths deaths)
esttab using 201117_a/table_robust_ftwork.tex, replace label title(Robustness: Full-Time Work Ratio) noobs s(N r2_a zipFE citydayFE countydayFE statedayFE cluster, label("N" "Adj. R-squared" "Zip-code FE" "City-Day FE"  "County-Day FE"  "State-Day FE"  "Clusters" ) fmt(0 %9.3f)) star(* .10 ** .05 *** .01) nocon b(3) drop(_cons 0.prepolicy_30day* demo_asian population_log  establishment_log teleworkable_emp_establish social_capital_county 1.prepolicy_30day exposure_total_scaled) order(1.prepolicy_30day#c.exposure_total_scaled 1.prepolicy_30day 1.prepolicy_30day#c.social_capital_county  1.prepolicy_30day#c.cases cases 1.prepolicy_30day#c.deaths deaths)
...
estadd local sample "<=10%"
estadd local cluster "State"
esttab using 201117_a/table_robust_employeeweight.rtf, replace label title(Robustness: Weight by Employees) noobs s(N r2_a sample  zipFE  countydayFE  cluster, label("N" "Adj. R-squared"   "Exposure Employee-Weight" "Zip-code FE"  "County-Day FE"  "Clusters" ) fmt(0 %9.3f)) star(* .10 ** .05 *** .01) nocon b(3) drop(_cons 0.prepolicy_30day* demo_asian population_log  establishment_log teleworkable_emp_establish 1.prepolicy_30day exposure_total_scaled) order(1.prepolicy_30day#c.exposure_total_scaled)
esttab using 201117_a/table_robust_employeeweight.tex, replace label title(Robustness: Weight by Employees) noobs s(N r2_a sample  zipFE  countydayFE  cluster, label("N" "Adj. R-squared"   "Exposure Employee-Weight" "Zip-code FE"  "County-Day FE"  "Clusters" ) fmt(0 %9.3f)) star(* .10 ** .05 *** .01) nocon b(3) drop(_cons 0.prepolicy_30day* demo_asian population_log  establishment_log teleworkable_emp_establish 1.prepolicy_30day exposure_total_scaled) order(1.prepolicy_30day#c.exposure_total_scaled)

** Robust C: Placebo
local control demo_asian population_log  establishment_log teleworkable_emp_establish
eststo clear
eststo: qui  reghdfe device_home_ratio i.prepolicy_30day c.placebo_exposure_total_scaled i.prepolicy_30day#c.placebo_exposure_total_scaled  `control'  i.prepolicy_30day#c.demo_asian i.prepolicy_30day#c.population_log i.prepolicy_30day#c.establishment_log i.prepolicy_30day#c.teleworkable_emp_establish if  placebo_ratio>0.8 | no_any_exposure==1, absorb(county_fips#date zipcode) vce(cluster state_fips)
estadd local zipFE "Yes"
estadd local countydayFE "Yes"
...
estadd local sample "High"
estadd local cluster "State"
esttab using 201117_a/table_robust_placebo.rtf, replace label title(Robustness: Placebo) noobs s(N r2_a sample zipFE  countydayFE  cluster, label("N" "Adj. R-squared" "China-Italy Ratio"  "Zip-code FE"  "County-Day FE"   "Clusters" ) fmt(0 %9.3f)) star(* .10 ** .05 *** .01) nocon b(3) drop(_cons 0.prepolicy_30day* demo_asian population_log  establishment_log teleworkable_emp_establish 1.prepolicy_30day exposure_total_scaled placebo_exposure_total_scaled *0.any_exposure_binary 1.any_exposure_binary  *0.placebo_exposure_binary 1.placebo_exposure_binary 0.prepolicy_30day*) order( 1.prepolicy_30day#c.placebo_exposure_total_scaled  1.prepolicy_30day#1.placebo_exposure_binary 1.prepolicy_30day#c.exposure_total_scaled 1.prepolicy_30day#1.any_exposure_binary )
esttab using 201117_a/table_robust_placebo.tex, replace label title(Robustness: Placebo) noobs s(N r2_a sample zipFE  countydayFE  cluster, label("N" "Adj. R-squared" "China-Italy Ratio"  "Zip-code FE"  "County-Day FE"   "Clusters" ) fmt(0 %9.3f)) star(* .10 ** .05 *** .01) nocon b(3) drop(_cons 0.prepolicy_30day* demo_asian population_log  establishment_log teleworkable_emp_establish 1.prepolicy_30day exposure_total_scaled placebo_exposure_total_scaled *0.any_exposure_binary 1.any_exposure_binary  *0.placebo_exposure_binary 1.placebo_exposure_binary 0.prepolicy_30day*) order( 1.prepolicy_30day#c.placebo_exposure_total_scaled  1.prepolicy_30day#1.placebo_exposure_binary 1.prepolicy_30day#c.exposure_total_scaled 1.prepolicy_30day#1.any_exposure_binary )
...
esttab using 201117_a/table_cross_trust.rtf, replace label title(Cross Sectional: Trust) noobs s(N r2_a  sample zipFE  countydayFE  cluster, label("N" "Adj. R-squared" "Sample" "Zip-code FE" "County-Day FE"   "Clusters" ) fmt(0 %9.3f)) star(* .10 ** .05 *** .01) nocon b(3) drop(_cons 0.prepolicy_30day* demo_asian population_log  establishment_log teleworkable_emp_establish 1.prepolicy_30day exposure_total_scaled) order(1.prepolicy_30day#c.exposure_total_scaled 1.prepolicy_30day exposure_total_scaled)
esttab using 201117_a/table_cross_trust.tex, replace label title(Cross Sectional: Trust) noobs s(N r2_a  sample zipFE  countydayFE  cluster, label("N" "Adj. R-squared" "Sample" "Zip-code FE" "County-Day FE"   "Clusters" ) fmt(0 %9.3f)) star(* .10 ** .05 *** .01) nocon b(3) drop(_cons 0.prepolicy_30day* demo_asian population_log  establishment_log teleworkable_emp_establish 1.prepolicy_30day exposure_total_scaled) order(1.prepolicy_30day#c.exposure_total_scaled 1.prepolicy_30day exposure_total_scaled)
...
eststo: qui reghdfe device_home_ratio  i.prepolicy_30day c.exposure_total_scaled i.prepolicy_30day#c.exposure_total_scaled  `control' i.prepolicy_30day#c.demo_asian i.prepolicy_30day#c.population_log i.prepolicy_30day#c.establishment_log i.prepolicy_30day#c.teleworkable_emp_establish  if ourcamp_mayor_politics=="R", absorb(county_fips#date zipcode) vce(cluster state_fips)
estadd local zipFE "Yes"
estadd local countydayFE "Yes"
estadd local cluster "State"
estadd local sample "Republican Mayor"
eststo: qui reghdfe device_home_ratio  i.prepolicy_30day c.exposure_total_scaled i.prepolicy_30day#c.exposure_total_scaled  `control' i.prepolicy_30day#c.demo_asian i.prepolicy_30day#c.population_log i.prepolicy_30day#c.establishment_log i.prepolicy_30day#c.teleworkable_emp_establish  if ourcamp_mayor_politics=="D", absorb(county_fips#date zipcode) vce(cluster state_fips)
estadd local zipFE "Yes"
estadd local countydayFE "Yes"
estadd local cluster "State"
estadd local sample "Democratic Mayor"
esttab using 201117_a/table_cross_party.rtf, replace label title(Cross Sectional: Political Affiliation) noobs s(N r2_a sample zipFE countydayFE  cluster, label("N" "Adj. R-squared" "Sample" "Zip-code FE" "County-Day FE"  "Clusters" ) fmt(0 %9.3f)) star(* .10 ** .05 *** .01) nocon b(3) drop(_cons 0.prepolicy_* demo_asian population_log  establishment_log teleworkable_emp_establish 1.prepolicy_30day exposure_total_scaled)
esttab using 201117_a/table_cross_party.tex, replace label title(Cross Sectional: Political Affiliation) noobs s(N r2_a sample zipFE countydayFE  cluster, label("N" "Adj. R-squared" "Sample" "Zip-code FE" "County-Day FE"  "Clusters" ) fmt(0 %9.3f)) star(* .10 ** .05 *** .01) nocon b(3) drop(_cons 0.prepolicy_* demo_asian population_log  establishment_log teleworkable_emp_establish 1.prepolicy_30day exposure_total_scaled)
...
eststo clear
eststo: qui reghdfe device_home_ratio  c.exposure_total_scaled   `control'  if prepolicy_30day==1 , absorb(county_fips#date) vce(cluster state_fips)
estadd local countydayFE "Yes"
estadd local cluster "State"
estadd local sample "All"
eststo: qui reghdfe device_home_ratio  c.exposure_total_scaled   `control'  if prepolicy_30day==1 & teleworkable_emp_establish>0.29 & !missing(teleworkable_emp_establish), absorb(county_fips#date) vce(cluster state_fips)
estadd local countydayFE "Yes"
estadd local cluster "State"
estadd local sample "25%"
eststo: qui reghdfe device_home_ratio  c.exposure_total_scaled   `control'  if prepolicy_30day==1 & teleworkable_emp_establish>0.33 & !missing(teleworkable_emp_establish), absorb(county_fips#date) vce(cluster state_fips)
estadd local countydayFE "Yes"
estadd local cluster "State"
estadd local sample "50%"
eststo: qui reghdfe device_home_ratio  c.exposure_total_scaled   `control'  if prepolicy_30day==1 & teleworkable_emp_establish>0.38 & !missing(teleworkable_emp_establish), absorb(county_fips#date) vce(cluster state_fips)
estadd local countydayFE "Yes"
estadd local cluster "State"
estadd local sample "75%"
esttab using 201117_a/table_cross_telework.rtf, replace label title(Cross Sectional: Teleworkability) noobs s(N r2_a sample countydayFE  cluster, label("N" "Adj. R-squared" "Teleworkability" "County-Day FE"  "Clusters" ) fmt(0 %9.3f)) star(* .10 ** .05 *** .01) nocon b(3) drop(_cons ) order(exposure_total_scaled)
esttab using 201117_a/table_cross_telework.tex, replace label title(Cross Sectional: Teleworkability) noobs s(N r2_a sample countydayFE  cluster, label("N" "Adj. R-squared" "Teleworkability" "County-Day FE"  "Clusters" ) fmt(0 %9.3f)) star(* .10 ** .05 *** .01) nocon b(3) drop(_cons ) order(exposure_total_scaled)
...
estadd local control "Yes"
esttab using 201117_a/table_appendix_day.rtf, replace label title(Robustness: Days Sensitivity) noobs s(N r2_a sample control zipFE countydayFE  cluster, label("N" "Adj. R-squared" "Period Before Policy" "Interacted Control" "Zip-code FE"  "County-Day FE" "Clusters" ) fmt(0 %9.3f)) star(* .10 ** .05 *** .01) nocon b(3) keep(1.prepolicy_10day#c.exposure_total_scaled 1.prepolicy_20day#c.exposure_total_scaled 1.prepolicy_30day#c.exposure_total_scaled 1.prepolicy_40day#c.exposure_total_scaled )
esttab using 201117_a/table_appendix_day.tex, replace label title(Robustness: Days Sensitivity) noobs s(N r2_a sample control zipFE countydayFE  cluster, label("N" "Adj. R-squared" "Period Before Policy" "Interacted Control" "Zip-code FE"  "County-Day FE" "Clusters" ) fmt(0 %9.3f)) star(* .10 ** .05 *** .01) nocon b(3) keep(1.prepolicy_10day#c.exposure_total_scaled 1.prepolicy_20day#c.exposure_total_scaled 1.prepolicy_30day#c.exposure_total_scaled 1.prepolicy_40day#c.exposure_total_scaled )
