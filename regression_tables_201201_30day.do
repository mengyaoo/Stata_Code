...
esttab using 201201_30day/table_cross_trust.rtf, replace label title(Cross Sectional: Trust) noobs s(N r2_a  sample cityFE  statedayFE  cluster, label("N" "Adj. R-squared" "Sample" "City FE" "State-Day FE"   "Clusters" ) fmt(0 %9.3f)) star(* .10 ** .05 *** .01) nocon b(3) drop(_cons 0.prepolicy_30day* demo_asian population_log  establishment_log teleworkable_emp_establish 1.prepolicy_30day exposure_total_scaled) order(1.prepolicy_30day#c.exposure_total_scaled 1.prepolicy_30day exposure_total_scaled)
esttab using 201201_30day/table_cross_trust.tex, replace label title(Cross Sectional: Trust) noobs s(N r2_a  sample cityFE  statedayFE  cluster, label("N" "Adj. R-squared" "Sample" "City FE" "State-Day FE"   "Clusters" ) fmt(0 %9.3f)) star(* .10 ** .05 *** .01) nocon b(3) drop(_cons 0.prepolicy_30day* demo_asian population_log  establishment_log teleworkable_emp_establish 1.prepolicy_30day exposure_total_scaled) order(1.prepolicy_30day#c.exposure_total_scaled 1.prepolicy_30day exposure_total_scaled)
...
estadd local control "Yes"
esttab using 201201_30day/table_appendix_day.rtf, replace label title(Robustness: Days Sensitivity) noobs s(N r2_a sample control cityFE statedayFE  cluster, label("N" "Adj. R-squared" "Period Before Policy" "Interacted Control" "City FE"  "State-Day FE" "Clusters" ) fmt(0 %9.3f)) star(* .10 ** .05 *** .01) nocon b(3) keep(1.prepolicy_10day#c.exposure_total_scaled 1.prepolicy_20day#c.exposure_total_scaled 1.prepolicy_30day#c.exposure_total_scaled 1.prepolicy_40day#c.exposure_total_scaled )
esttab using 201201_30day/table_appendix_day.tex, replace label title(Robustness: Days Sensitivity) noobs s(N r2_a sample control cityFE statedayFE  cluster, label("N" "Adj. R-squared" "Period Before Policy" "Interacted Control" "City FE"  "State-Day FE" "Clusters" ) fmt(0 %9.3f)) star(* .10 ** .05 *** .01) nocon b(3) keep(1.prepolicy_10day#c.exposure_total_scaled 1.prepolicy_20day#c.exposure_total_scaled 1.prepolicy_30day#c.exposure_total_scaled 1.prepolicy_40day#c.exposure_total_scaled )
