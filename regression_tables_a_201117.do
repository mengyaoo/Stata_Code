...
estadd local sample "Low"
estadd local cluster "State"
eststo: qui  reghdfe device_home_ratio i.prepolicy_30day c.exposure_total_scaled i.prepolicy_30day#c.exposure_total_scaled  `control'  i.prepolicy_30day#c.demo_asian i.prepolicy_20day#c.population_log i.prepolicy_30day#c.establishment_log i.prepolicy_30day#c.teleworkable_emp_establish if  placebo_ratio<=0.8 | no_any_exposure==1, absorb(county_fips#date zipcode) vce(cluster state_fips)
estadd local zipFE "Yes"
estadd local countydayFE "Yes"
